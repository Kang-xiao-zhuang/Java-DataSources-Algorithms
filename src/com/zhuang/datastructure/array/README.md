...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c2c36e4fb0d543cab39add53f82204cd~tplv-k3u1fbpfcp-zoom-1.image)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9080b02be5464942bc9228e9115f7987~tplv-k3u1fbpfcp-zoom-1.image)


但很遗憾，第二次内循环要的是 $[1,0]$ 这条数据，缓存中没有，于是再读入了下图的数据

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d92de093dfcf49569fd2c2ca2e35093d~tplv-k3u1fbpfcp-zoom-1.image)


这显然是一种浪费，因为 $[0,1] ... [0,13]$ 包括 $[1,1] ... [1,13]$ 这些数据虽然读入了缓存，却没有及时用上，而缓存的大小是有限的，等执行到第九次内循环时

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/37070323aff24b7bb46336b6e0de07e6~tplv-k3u1fbpfcp-zoom-1.image)
